...
class System:
    ...
    def compute_acceleration(self,n,timestep):
        ...
        # Divide timestep into parts of 100
        timestep_divided = timestep/100
        while timestep_divided <= timestep:
            ...
            for i in self.body_list:
                ...
                if i != self.body_list[n]:
                    ...
                    # Update total directional acceleration per 1/100 timestep
                    total_ax += ax
                    total_ay += ay

                    #iterate through timesteps
                    timestep_divided += timestep_divided
