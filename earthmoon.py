...
# CS 1
# 10/23/15
# Program to create a model of the moon orbiting the earth
...
def main():
    ...
    moon = Body(7.3477e22, 3.84403e8, 1, 0, 1022, 4, 1, 1, 1)   # white moon
...
start_graphics(main, "Earth-moon simulation", WINDOW_WIDTH, WINDOW_HEIGHT, True)